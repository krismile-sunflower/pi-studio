...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::packages::install_pi_package,
            commands::packages::list_pi_packages,
            commands::packages::remove_pi_package,
            commands::packages::search_pi_packages,
            commands::prompts::list_pi_prompts,
            ...
            commands::git::stage_all_git,
            commands::git::stage_git_files,
            commands::git::unstage_all_git,
